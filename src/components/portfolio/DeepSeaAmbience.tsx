  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 left-0 w-24 sm:w-44 opacity-35 backdrop-blur-[1px] blur-[0.4px] transition-opacity duration-700">
        ...
        >
          <svg
            className="h-16 w-14 text-primary/75 filter drop-shadow-[0_0_10px_currentColor]"
            viewBox="0 0 60 50"
            fill="none"
          >
            {/* Lure stalk & glowing esca */}
            <path
              d="M22 18 C20 4 36 6 36 12"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
            />
            ...
            <path
              d="M16 27 L17 31 M20 28 L21 32 M24 28 L25 31"
              stroke="currentColor"
              strokeWidth="1"
              strokeLinecap="round"
            />
        ...
        >
          <svg
            className="h-14 w-10 text-cyan-400/70 filter drop-shadow-[0_0_8px_currentColor]"
            viewBox="0 0 40 60"
            fill="none"
          >
            <path
        ...
        <div
          className="absolute -bottom-6 left-1 h-56 w-20 origin-bottom"
          style={{ animation: "kelpSway 9s ease-in-out infinite alternate" }}
        >
        ...
        <div
          className="absolute left-10 top-[40%] h-2 w-2 rounded-full border border-cyan-400/50 bg-cyan-400/10"
          style={{ animation: "deepBubble 9s linear infinite" }}
        />
        <div
          className="absolute left-4 top-[80%] h-2.5 w-2.5 rounded-full border border-primary/50 bg-primary/10"
          style={{ animation: "deepBubble 13s linear 3s infinite" }}
        />
      </div>
      ...
      <div className="absolute inset-y-0 right-0 w-24 sm:w-44 opacity-35 backdrop-blur-[1px] blur-[0.4px] transition-opacity duration-700">
        ...
        >
          <svg
            className="h-14 w-16 text-cyan-400/70 filter drop-shadow-[0_0_8px_currentColor]"
            viewBox="0 0 60 50"
            fill="none"
          >
            {/* Wing body */}
            ...
            <path
              d="M26 10 Q24 6 26 4 M34 10 Q36 6 34 4"
              stroke="currentColor"
              strokeWidth="1"
              opacity="0.8"
            />
        ...
        >
          <svg
            className="h-12 w-8 text-primary/75 filter drop-shadow-[0_0_8px_currentColor]"
            viewBox="0 0 30 50"
            fill="none"
          >
            <ellipse
            ...
            />
            <path
              d="M15 5 Q15 20 15 35"
              stroke="currentColor"
              strokeWidth="1.2"
              strokeDasharray="2 2"
            />
            <path
              d="M19 7 Q21 20 19 33"
              stroke="#38bdf8"
              strokeWidth="1"
              strokeDasharray="2 2"
              className="animate-pulse"
        ...
        <div
          className="absolute -bottom-6 right-2 h-60 w-24 origin-bottom"
          style={{ animation: "kelpSway 11s ease-in-out 2s infinite alternate-reverse" }}
        >
        ...
        {/* Rising micro-bubbles */}
        <div
          className="absolute right-8 top-[36%] h-2.5 w-2.5 rounded-full border border-sky-400/50 bg-sky-400/10"
          style={{ animation: "deepBubble 11s linear 1.5s infinite" }}
        />
        <div
          className="absolute right-12 top-[72%] h-2 w-2 rounded-full border border-primary/50 bg-primary/10"
          style={{ animation: "deepBubble 14s linear 5s infinite" }}
        />
      </div>
