...
export function Hero({ onOpenResume }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-40 top-1/3 h-[420px] w-[420px] rounded-full blur-3xl opacity-60"
        style={{
          background:
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-3xl grid-cols-1 items-center gap-10 md:grid-cols-[1.1fr_1fr]">
        <div>
          ...
          <h1 className="font-hero leading-[1] tracking-tight">
            ...
            <span className="block text-5xl text-gradient-green sm:text-6xl md:text-7xl">
              Verma
            </span>
          </h1>
        ...
        <div className="text-xs leading-relaxed text-muted-foreground sm:text-sm">
          <p>
            Software Engineer building reliable, scalable products across the stack. I enjoy turning
            complex problems into well-designed systems, thoughtful features, and intuitive
            experiences.
          </p>
          <p className="mt-3">
            Currently diving deeper into distributed systems, cloud infrastructure, and AI-powered
            applications. Always learning, building, and refining how I engineer.
          </p>
        </div>
      </div>
    </section>
